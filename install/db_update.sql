...
CREATE TABLE IF NOT EXISTS `fantasy_teams_scoring` (`id` int(11) NOT NULL auto_increment,  `team_id` int(11) NOT NULL,  `league_id` int(11) NOT NULL default '0',  `scoring_period_id` tinyint(4) NOT NULL default '1',  `value_0` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_1` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_2` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_3` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_4` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_5` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_6` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_7` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_8` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_9` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_10` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `value_11` varchar(15) collate utf8_unicode_ci NOT NULL default '0',  `total` varchar(15) collate utf8_unicode_ci NOT NULL,PRIMARY KEY  (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
