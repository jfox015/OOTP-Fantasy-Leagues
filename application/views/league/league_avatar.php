    ...
    <h1><?php echo($subTitle); ?></h1>
        ...
        <div class="content-form">
			...
			echo('<img src="'.PATH_LEAGUES_AVATARS.$avatar.'" border="0" width="50" height="50" align="left" />');
			?>
            <br clear="all" /><br /><br />
            <?php
			echo(form_open_multipart($config['fantasy_web_root']."league/avatar",array("id"=>"detailsForm","name"=>"detailsForm")));
			echo(form_fieldset());
