...
<p>[EXPIRES]</p>
';
$lang['team_trade_accepted'] = 'To [USERNAME],
...
<p>Your trade offer to the [ACCEPTING_TEAM_NAME] has been rejected by the league. The minimum number of trade protests were recieved by the deadline. No players have been assigned to new rosters.</p>';

$lang['team_trade_rejected_commish'] = 'To [USERNAME],
<p>Your trade offer to the [ACCEPTING_TEAM_NAME] has been rejected by the league commissioner. No players have been assigned to new rosters. The reason given for tyhe rejection was:</p>
<p>
[COMMENTS]</p>';

$lang['team_trade_rejected_admin'] = 'To [USERNAME],
<p>Your trade offer to the [ACCEPTING_TEAM_NAME] has been rejected by the administrator of the site. No players have been assigned to new rosters. The reason given for tyhe rejection was:</p>
<p>
[COMMENTS]</p>';
